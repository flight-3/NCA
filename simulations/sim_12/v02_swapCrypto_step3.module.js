...
.swapCrypto_step3_main-container {
  grid-row-gap: 24px;
  flex-direction: column;
  justify-content: flex-start;
  align-items: stretch;
...
.swapCrypto_step3_header-container {
  grid-row-gap: 16px;
  flex-direction: column;
  justify-content: flex-start;
  align-items: stretch;
...
.swapCrypto_step3_title-container {
  grid-row-gap: 16px;
  flex-direction: column;
  justify-content: center;
...
.swapCrypto_step3_tab-container {
...
.swapCrypto_step3_limit-price-container {
  grid-row-gap: 8px;
...
.swapCrypto_step3_limit-price-label {
  color: #2f2f30;
  letter-spacing: -.04em;
  flex: none;
  margin-top: 0;
...
.swapCrypto_step3_limit-price-input-container {
...
.swapCrypto_step3_limit-price-input-container.is--alt {
  justify-content: space-between;
  align-items: flex-start;
  margin-bottom: -8px;
}

.swapCrypto_step3_currency-label-container {
  grid-row-gap: 4px;
  flex-direction: column;
  justify-content: center;
  align-items: flex-start;
...
.swapCrypto_step3_currency-label {
  grid-column-gap: 8px;
  flex: 0 auto;
  justify-content: flex-start;
  align-items: flex-start;
...
.swapCrypto_step3_price-input-container {
  flex-direction: column;
  flex: 1;
  justify-content: center;
...
.swapCrypto_step3_price-input.is--value {
  opacity: 1;
}

.swapCrypto_step3_price-input.is--error {
  color: #d93a3a;
  opacity: 1;
}

.swapCrypto_step3_market-button {
...
.swapCrypto_step3_selling-amount-container {
  grid-column-gap: 8px;
...
.swapCrypto_step3_selling-amount-label-text {
  color: #7a7a7a;
  letter-spacing: -.04em;
  margin-top: 0;
  margin-bottom: 0;
...
.swapCrypto_step3_selling-currency-container {
...
.swapCrypto_step3_selling-currency-label-text {
  color: #1f1f1f;
  letter-spacing: -.04em;
  margin-top: 0;
  margin-bottom: 0;
...
.swapCrypto_step3_selling-price-usd {
  opacity: .2;
  color: #1f1f1f;
  letter-spacing: -.04em;
  margin-top: 0;
...
.swapCrypto_step3_right-container {
  grid-row-gap: 24px;
  flex-direction: column;
  justify-content: flex-start;
  align-items: flex-start;
...
.swapCrypto_step3_right-top-container {
  grid-row-gap: 8px;
  flex-direction: column;
  justify-content: flex-start;
  align-items: stretch;
...
.swapCrypto_step3_right-selling-container {
  grid-row-gap: 8px;
  cursor: pointer;
  background-color: #f9f9f9;
  border: 2px solid #f64c07;
...
.swapCrypto_step3_right-slippage-container {
  grid-column-gap: 40px;
  justify-content: flex-start;
  align-items: center;
  width: 100%;
...
.swapCrypto_step3_viewrates_container {
  grid-row-gap: 8px;
  background-color: #f9f9f9;
  border: 2px solid #ebebeb;
  border-radius: 12px;
...
.swapCrypto_step3_viewrates_text {
  opacity: .8;
  color: #7a7a7a;
  letter-spacing: -.04em;
  margin-top: 0;
...
.swapCrypto_step3_buttons-5.is--inactive {
  opacity: .5;
  pointer-events: none;
}

.swapCrypto_step3_button-large-5 {
  color: #fff;
  letter-spacing: -.02em;
  margin-top: 0;
  margin-bottom: 0;
...
.swapCrypto_step3_exch-ico-inner {
  flex: none;
  width: 24px;
  height: 24px;
}

.swapCrypto_step3_wallet-ico {
  flex: none;
  width: 16px;
  height: 16px;
}

.swapCrypto_step3_chev-ico {
  flex: none;
  width: 24px;
  height: 24px;
}

.swapCrypto_step3_cur-ico-img {
  object-fit: cover;
  width: 32px;
  height: 32px;
}

.swapCrypto_step3_selection_dropdown {
  z-index: 999;
  opacity: 0;
  background-color: #fff;
  border: 2px solid #ebebeb;
...
.swapCrypto_step3_selection_dropdown.is--active {
  opacity: 1;
  display: flex;
}

.swapCrypto_step3_select_crypto-item {
  grid-column-gap: 16px;
  grid-row-gap: 16px;
  cursor: pointer;
  border-radius: 12px;
...
.swapCrypto_step3_select_crypto-item:hover {
  background-color: #f8f8f8;
}

.swapCrypto_step3_select_crypto-details {
  grid-column-gap: 12px;
  grid-row-gap: 12px;
  justify-content: flex-start;
  align-items: center;
...
.swapCrypto_step3_crypto-detail-name {
  color: #1f1f1f;
  font-size: 16px;
  font-weight: 600;
  line-height: 130%;
...
.swapCrypto_step3_crypto-detail-abbr {
  color: #7a7a7a;
  font-weight: 400;
}

.swapCrypto_step3_select-d-line {
...
.swapCrypto_step3_sim-toast.is--visible {
  opacity: 1;
  transform: translateY(0);
}

.swapCrypto_step3_sim-toast_wrap {
  position: absolute;
  bottom: 40px;
  height: 0px;
}
    ...
    rootEl.innerHTML = `
      <div class="swapCrypto_step3_canvas-wrap">
        <div data-sim-view data-sim-view-1 class="swapCrypto_step3_container">
          <div class="swapCrypto_step3_main-container">
            <div class="swapCrypto_step3_header-container">
              <div class="swapCrypto_step3_title-container">
                <div class="swapCrypto_step3_title-style">Swap</div>
              </div>
            </div>
            <div data-sim-tab-contain class="swapCrypto_step3_tab-container">
              <div data-sim-tab-1 class="swapCrypto_step3_right-container">
                <div class="swapCrypto_step3_right-top-container">
                  <div data-sim-sell-area class="swapCrypto_step3_right-selling-container">
                    <div class="swapCrypto_step3_limit-price-input-container">
                      <div class="swapCrypto_step3_limit-price-label">Selling</div>
                      <div class="swapCrypto_step3_selling-amount-container">
                        <div class="swapCrypto_step3_currency-label-container">
                          <div class="swapCrypto_step3_currency-label">
                            <div class="swapCrypto_step3_selling-amount-label-text">
                              Balance:
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 16 16" fill="none" class="swapCrypto_step3_wallet-ico">
                    ...
                    <div class="swapCrypto_step3_limit-price-input-container is--alt">
                      <div data-sim-selling-crypto class="swapCrypto_step3_selling-currency-container">
                        <div class="swapCrypto_step3_market-button">
                          <div data-sim-selected-selling-ico class="swapCrypto_step3_cur-ico">
                            <img src="https://cdn.prod.website-files.com/68f62d7ec4ced98ccbd356d8/69182e5cad7c2be8398af2e8_eth-logo.svg" class="swapCrypto_step3_cur-ico-img">
                          </div>
                          <div class="swapCrypto_step3_currency-label-container">
                            <div class="swapCrypto_step3_currency-label">
                              <div data-sim-selected-selling class="swapCrypto_step3_selling-currency-label-text">ETH</div>
                            </div>
                          </div>
                        </div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 24 24" fill="none" class="swapCrypto_step3_chev-ico">
                        ...
                        <div data-sim-sell-dropdown class="swapCrypto_step3_selection_dropdown">
                          <div data-sim-crypto-select="btc" class="swapCrypto_step3_select_crypto-item">
                            <div data-sim-crypto-img class="swapCrypto_step3_cur-ico">
                              <img src="https://cdn.prod.website-files.com/68f62d7ec4ced98ccbd356d8/69182e5cdc09e9e742cbdff5_btc-logo.svg" class="swapCrypto_step3_cur-ico-img">
                            </div>
                            <div class="swapCrypto_step3_select_crypto-details">
                              <div class="swapCrypto_step3_crypto-detail-name">Bitcoin</div>
                              <div data-sim-crypto-name class="swapCrypto_step3_crypto-detail-abbr">BTC</div>
                            </div>
                          </div>
                          <div class="swapCrypto_step3_select-d-line"></div>
                          <div data-sim-crypto-select="eth" class="swapCrypto_step3_select_crypto-item">
                            <div data-sim-crypto-img class="swapCrypto_step3_cur-ico">
                              <img src="https://cdn.prod.website-files.com/68f62d7ec4ced98ccbd356d8/69182e5cad7c2be8398af2e8_eth-logo.svg" class="swapCrypto_step3_cur-ico-img">
                            </div>
                            <div class="swapCrypto_step3_select_crypto-details">
                              <div class="swapCrypto_step3_crypto-detail-name">Ethereum</div>
                              <div data-sim-crypto-name class="swapCrypto_step3_crypto-detail-abbr">ETH</div>
                            </div>
                          </div>
                          <div class="swapCrypto_step3_select-d-line"></div>
                          <div data-sim-crypto-select="xrp" class="swapCrypto_step3_select_crypto-item">
                            <div data-sim-crypto-img class="swapCrypto_step3_cur-ico">
                              <img src="https://cdn.prod.website-files.com/68f62d7ec4ced98ccbd356d8/69182e5cecd803e93aa1a9d1_xrp-logo.svg" class="swapCrypto_step3_cur-ico-img">
                            </div>
                            <div class="swapCrypto_step3_select_crypto-details">
                              <div class="swapCrypto_step3_crypto-detail-name">XRP</div>
                              <div data-sim-crypto-name class="swapCrypto_step3_crypto-detail-abbr">XRP</div>
                            </div>
                          </div>
                          <div class="swapCrypto_step3_select-d-line"></div>
                          <div data-sim-crypto-select="bnb" class="swapCrypto_step3_select_crypto-item">
                            <div data-sim-crypto-img class="swapCrypto_step3_cur-ico">
                              <img src="https://cdn.prod.website-files.com/68f62d7ec4ced98ccbd356d8/69182e5c63efaa27da6d1b15_bnb-logo.svg" class="swapCrypto_step3_cur-ico-img">
                            </div>
                            <div class="swapCrypto_step3_select_crypto-details">
                              <div class="swapCrypto_step3_crypto-detail-name">BNB</div>
                              <div data-sim-crypto-name class="swapCrypto_step3_crypto-detail-abbr">BNB</div>
                            </div>
                          </div>
                          <div class="swapCrypto_step3_select-d-line"></div>
                          <div data-sim-crypto-select="usdc" class="swapCrypto_step3_select_crypto-item">
                            <div data-sim-crypto-img class="swapCrypto_step3_cur-ico">
                              <img src="https://cdn.prod.website-files.com/68f62d7ec4ced98ccbd356d8/69182e5c5c1e6e07d92c9228_usdc-logo.svg" class="swapCrypto_step3_cur-ico-img">
                            </div>
                            <div class="swapCrypto_step3_select_crypto-details">
                              <div class="swapCrypto_step3_crypto-detail-name">USDC</div>
                              <div data-sim-crypto-name class="swapCrypto_step3_crypto-detail-abbr">USDC</div>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="swapCrypto_step3_price-input-container">
                        <div data-sim-selling-input class="swapCrypto_step3_price-input" tabindex="0" contenteditable="true">0.00</div>
                        <div data-sim-selling-usd-value class="swapCrypto_step3_selling-price-usd">$0</div>
                      </div>
                    </div>
                  </div>

                  <div class="swapCrypto_step3_exch-ico">
                    <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 24 24" fill="none" class="swapCrypto_step3_exch-ico-inner">
                  ...
                  <div data-sim-buy-area class="swapCrypto_step3_limit-price-container">
                    <div class="swapCrypto_step3_limit-price-input-container">
                      <div class="swapCrypto_step3_limit-price-label">Buying</div>
                      <div class="swapCrypto_step3_selling-amount-container">
                        <div class="swapCrypto_step3_currency-label-container">
                          <div class="swapCrypto_step3_currency-label">
                            <div class="swapCrypto_step3_selling-amount-label-text">
                    ...
                    <div class="swapCrypto_step3_limit-price-input-container">
                      <div data-sim-buying-crypto class="swapCrypto_step3_selling-currency-container">
                        <div class="swapCrypto_step3_market-button">
                          <div data-sim-selected-buying-ico class="swapCrypto_step3_cur-ico">
                            <img src="https://cdn.prod.website-files.com/68f62d7ec4ced98ccbd356d8/69182e5c5c1e6e07d92c9228_usdc-logo.svg" class="swapCrypto_step3_cur-ico-img">
                          </div>
                          <div class="swapCrypto_step3_currency-label-container">
                            <div class="swapCrypto_step3_currency-label">
                              <div data-sim-selected-buying class="swapCrypto_step3_selling-currency-label-text">USDC</div>
                            </div>
                          </div>
                        </div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 24 24" fill="none" class="swapCrypto_step3_chev-ico">
                        ...
                        <div data-sim-buy-dropdown class="swapCrypto_step3_selection_dropdown">
                          <div data-sim-crypto-select="btc" class="swapCrypto_step3_select_crypto-item">
                            <div data-sim-crypto-img class="swapCrypto_step3_cur-ico">
                              <img src="https://cdn.prod.website-files.com/68f62d7ec4ced98ccbd356d8/69182e5cdc09e9e742cbdff5_btc-logo.svg" class="swapCrypto_step3_cur-ico-img">
                            </div>
                      ...
                      <div class="swapCrypto_step3_price-input-container">
                        <div data-sim-buying-input class="swapCrypto_step3_price-input" tabindex="0" contenteditable="true">0.00</div>
                      </div>
                    </div>
                  </div>
                </div>

                <div class="swapCrypto_step3_right-slippage-container">
                  <div class="swapCrypto_step3_viewrates_container">
                    <div data-sim-conversion-rate-text class="swapCrypto_step3_viewrates_text">Enter amount to view rates</div>
                  </div>
                </div>
              </div>

              <div data-sim-trigger-1 class="swapCrypto_step3_buttons-5 is--inactive">
                <div class="swapCrypto_step3_button-large-5">Swap</div>
              </div>
            </div>
          </div>
        </div>
        <div class="swapCrypto_step3_sim-toast_wrap">
          <div class="swapCrypto_step3_sim-toast" data-sim-toast>
