...
<div class="sendCrypto_step4_canvas-wrap">
  <div class="sendCrypto_step4_container">
    ...
    <div data-sim-trigger class="sendCrypto_step4_buttons">
      <div class="sendCrypto_step4_button-large-2">Next</div>
    </div>
  </div>
</div>
    `;
    ...
    // Pre-fill address with highlighted first + last 4 chars
    ...
    const middle = ADDRESS_VALUE.slice(4, -4);

    addressEl.innerHTML = `
      <span class="sendCrypto_step4_input-highlight">${first4}</span>${middle}
    ...
    // Activate trigger after 1s delay
    ...
    setTimeout(activateTrigger, 1000);
