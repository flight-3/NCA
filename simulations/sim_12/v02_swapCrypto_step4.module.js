...
export default {
  mount(rootEl, props = {}, callbacks = {}) {
    ...
    const STYLE_ID = "swapCrypto_step4_styles";
...
.swapCrypto_step4_main-container {
  grid-row-gap: 24px;
  flex-direction: column;
  justify-content: flex-start;
  align-items: stretch;
...
.swapCrypto_step4_header-container {
  grid-row-gap: 16px;
  flex-direction: column;
  justify-content: flex-start;
  align-items: stretch;
...
.swapCrypto_step4_title-container {
  grid-row-gap: 16px;
  flex-direction: column;
  justify-content: center;
...
.swapCrypto_step4_tab-container {
...
.swapCrypto_step4_limit-price-container {
  grid-row-gap: 8px;
...
.swapCrypto_step4_limit-price-label {
  color: #2f2f30;
  letter-spacing: -.04em;
  flex: none;
  margin-top: 0;
...
.swapCrypto_step4_limit-price-input-container {
...
.swapCrypto_step4_limit-price-input-container.is--alt {
  justify-content: space-between;
  align-items: flex-start;
  margin-bottom: -8px;
}

.swapCrypto_step4_currency-label-container {
  grid-row-gap: 4px;
  flex-direction: column;
  justify-content: center;
  align-items: flex-start;
...
.swapCrypto_step4_currency-label {
  grid-column-gap: 8px;
  flex: 0 auto;
  justify-content: flex-start;
  align-items: flex-start;
...
.swapCrypto_step4_price-input-container {
  flex-direction: column;
  flex: 1;
  justify-content: center;
...
.swapCrypto_step4_price-input.is--value {
  opacity: 1;
}

.swapCrypto_step4_price-input.is--error {
  color: #d93a3a;
  opacity: 1;
}

.swapCrypto_step4_market-button {
...
.swapCrypto_step4_selling-amount-container {
  grid-column-gap: 8px;
...
.swapCrypto_step4_selling-amount-label-text {
  color: #7a7a7a;
  letter-spacing: -.04em;
  margin-top: 0;
  margin-bottom: 0;
...
.swapCrypto_step4_selling-currency-container {
...
.swapCrypto_step4_selling-currency-label-text {
  color: #1f1f1f;
  letter-spacing: -.04em;
  margin-top: 0;
  margin-bottom: 0;
...
.swapCrypto_step4_selling-price-usd {
  opacity: .2;
  color: #1f1f1f;
  letter-spacing: -.04em;
  margin-top: 0;
...
.swapCrypto_step4_right-container {
  grid-row-gap: 24px;
  flex-direction: column;
  justify-content: flex-start;
  align-items: stretch;
...
.swapCrypto_step4_right-top-container {
  grid-row-gap: 8px;
  flex-direction: column;
  justify-content: flex-start;
  align-items: stretch;
...
.swapCrypto_step4_right-selling-container {
  grid-row-gap: 8px;
  background-color: #f9f9f9;
  border: 2px solid #f64c07;
  border-radius: 12px;
...
.swapCrypto_step4_right-slippage-container {
  grid-column-gap: 40px;
  justify-content: flex-start;
  align-items: center;
  width: 100%;
...
.swapCrypto_step4_viewrates_container {
  grid-row-gap: 8px;
  background-color: #f9f9f9;
  border: 2px solid #f64c07;
  border-radius: 12px;
...
.swapCrypto_step4_button-large-5 {
  color: #fff;
  letter-spacing: -.02em;
  margin-top: 0;
  margin-bottom: 0;
...
.swapCrypto_step4_exch-ico-inner {
  flex: none;
  width: 24px;
  height: 24px;
}

.swapCrypto_step4_wallet-ico {
  flex: none;
  width: 16px;
  height: 16px;
}

.swapCrypto_step4_chev-ico {
  flex: none;
  width: 24px;
  height: 24px;
}

.swapCrypto_step4_cur-ico-img {
  object-fit: cover;
  width: 32px;
  height: 32px;
}

.swapCrypto_step4_select_crypto-item {
  grid-column-gap: 16px;
  grid-row-gap: 16px;
  border-radius: 12px;
  justify-content: flex-start;
...
.swapCrypto_step4_select_crypto-item:hover {
  background-color: #f8f8f8;
}

.swapCrypto_step4_select_crypto-details {
  grid-column-gap: 12px;
  grid-row-gap: 12px;
  justify-content: flex-start;
  align-items: center;
...
.swapCrypto_step4_crypto-detail-name {
  color: #1f1f1f;
  font-size: 16px;
  font-weight: 600;
  line-height: 130%;
...
.swapCrypto_step4_crypto-detail-abbr {
  color: #7a7a7a;
  font-weight: 400;
}

.swapCrypto_step4_select-d-line {
...
.swapCrypto_step4_viewrates_top-wrap {
  display: flex;
  justify-content: space-between;
  color: #F64C07;
  font-size: 0.88rem;
...
.swapCrypto_step4_viewrates_btm-wrap {
  display: flex;
  justify-content: space-between;
  font-size: 0.88rem;
  padding: 8px 16px;
...
.swapCrypto_step4_viewrates_bold {
  font-weight: 500;
}

.swapCrypto_step4_viewrates_light {
  opacity: 0.7;
}
      `;
    ...
    // Static HTML for this step
    rootEl.innerHTML = `
      <div class="swapCrypto_step4_canvas-wrap">
        <div data-sim-view data-sim-view-1 class="swapCrypto_step4_container">
          <div class="swapCrypto_step4_main-container">
            <div class="swapCrypto_step4_header-container">
              <div class="swapCrypto_step4_title-container">
                <div class="swapCrypto_step4_title-style">Swap</div>
              </div>
            </div>
            <div data-sim-tab-contain class="swapCrypto_step4_tab-container">
              <div data-sim-tab-1 class="swapCrypto_step4_right-container">
                <div class="swapCrypto_step4_right-top-container">
                  <div data-sim-sell-area class="swapCrypto_step4_right-selling-container">
                    <div class="swapCrypto_step4_limit-price-input-container">
                      <div class="swapCrypto_step4_limit-price-label">Selling</div>
                      <div class="swapCrypto_step4_selling-amount-container">
                        <div class="swapCrypto_step4_currency-label-container">
                          <div class="swapCrypto_step4_currency-label">
                            <div class="swapCrypto_step4_selling-amount-label-text">
                              Balance:
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 16 16" fill="none" class="swapCrypto_step4_wallet-ico">
                    ...
                    <div class="swapCrypto_step4_limit-price-input-container is--alt">
                      <div data-sim-selling-crypto class="swapCrypto_step4_selling-currency-container">
                        <div class="swapCrypto_step4_market-button">
                          <div data-sim-selected-selling-ico class="swapCrypto_step4_cur-ico">
                            <img src="https://cdn.prod.website-files.com/68f62d7ec4ced98ccbd356d8/69182e5cad7c2be8398af2e8_eth-logo.svg" class="swapCrypto_step4_cur-ico-img">
                          </div>
                          <div class="swapCrypto_step4_currency-label-container">
                            <div class="swapCrypto_step4_currency-label">
                              <div data-sim-selected-selling class="swapCrypto_step4_selling-currency-label-text">ETH</div>
                            </div>
                          </div>
                        </div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 24 24" fill="none" class="swapCrypto_step4_chev-ico">
                      ...
                      <div class="swapCrypto_step4_price-input-container">
                        <div data-sim-selling-input class="swapCrypto_step4_price-input" tabindex="0" >0.00</div>
                        <div data-sim-selling-usd-value class="swapCrypto_step4_selling-price-usd">$0</div>
                      </div>
                    </div>
                  </div>

                  <div class="swapCrypto_step4_exch-ico">
                    <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 24 24" fill="none" class="swapCrypto_step4_exch-ico-inner">
                  ...
                  <div data-sim-buy-area class="swapCrypto_step4_limit-price-container">
                    <div class="swapCrypto_step4_limit-price-input-container">
                      <div class="swapCrypto_step4_limit-price-label">Buying</div>
                      <div class="swapCrypto_step4_selling-amount-container">
                        <div class="swapCrypto_step4_currency-label-container">
                          <div class="swapCrypto_step4_currency-label">
                            <div class="swapCrypto_step4_selling-amount-label-text">
                    ...
                    <div class="swapCrypto_step4_limit-price-input-container">
                      <div data-sim-buying-crypto class="swapCrypto_step4_selling-currency-container">
                        <div class="swapCrypto_step4_market-button">
                          <div data-sim-selected-buying-ico class="swapCrypto_step4_cur-ico">
                            <img src="https://cdn.prod.website-files.com/68f62d7ec4ced98ccbd356d8/69182e5c5c1e6e07d92c9228_usdc-logo.svg" class="swapCrypto_step4_cur-ico-img">
                          </div>
                          <div class="swapCrypto_step4_currency-label-container">
                            <div class="swapCrypto_step4_currency-label">
                              <div data-sim-selected-buying class="swapCrypto_step4_selling-currency-label-text">USDC</div>
                            </div>
                          </div>
                        </div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 24 24" fill="none" class="swapCrypto_step4_chev-ico">
                      ...
                      <div class="swapCrypto_step4_price-input-container">
                        <div data-sim-buying-input class="swapCrypto_step4_price-input" tabindex="0" >0.00</div>
                      </div>
                    </div>
                  </div>
                </div>

                <div class="swapCrypto_step4_right-slippage-container">
                  <div class="swapCrypto_step4_viewrates_container">
                    <div class="swapCrypto_step4_viewrates_top-wrap">
                      <span>Rate</span>
                      <div data-sim-conversion-rate-text class="swapCrypto_step4_viewrates_bold">1 USDC ≈ 0.0002524 ETH</div>
                    </div>
                    <div class="swapCrypto_step4_viewrates_btm-wrap">
                      <span class="swapCrypto_step4_viewrates_light">Platform fee</span>
                      <span class="swapCrypto_step4_viewrates_bold">0.01%</span>
                    </div>
                  </div>
                </div>
              </div>

              <div data-sim-trigger-1 class="swapCrypto_step4_buttons-5">
                <div class="swapCrypto_step4_button-large-5">Swap</div>
              </div>
            </div>
          </div>
        </div>
    ...
    const state = {
      ...
      buyAmount:
        typeof saved.buyAmount === "number" && isFinite(saved.buyAmount)
          ...
          : 0,
      conversionRateText:
        typeof saved.conversionRateText === "string"
          ? saved.conversionRateText
          : null,
    };

    // DOM refs we actually need
    const selectedSellingEls = view.querySelectorAll(
      "[data-sim-selected-selling]"
    );
    const selectedBuyingEls = view.querySelectorAll(
      "[data-sim-selected-buying]"
    );
    const sellingIconImg = view.querySelector(
      "[data-sim-selected-selling-ico] img"
    );
    const buyingIconImg = view.querySelector(
    ...
    if (!trigger1) {
      console.warn("[swapCrypto_step4] Missing trigger element.");
      return;
    }
    ...
    const getConversionRateText = () => {
      ...
      const formatted =
        rate < 0.00001
          ...
          : rate.toFixed(7).replace(/0+$/g, "").replace(/\.$/, "");
      const buySymbol =
        CRYPTOS[state.buyKey]?.symbol || state.buyKey.toUpperCase();
      const sellSymbol =
        CRYPTOS[state.sellKey]?.symbol || state.sellKey.toUpperCase();
      return `1 ${buySymbol} ≈ ${formatted} ${sellSymbol}`;
    };
    ...
    const syncSelectedLabels = () => {
      ...
      if (sellCrypto) {
        ...
        if (sellingIconImg) sellingIconImg.src = sellCrypto.img;
      }
      ...
      if (buyCrypto) {
        ...
        if (buyingIconImg) buyingIconImg.src = buyCrypto.img;
      }
    };

    const updateAmountsDisplay = () => {
      if (sellingInputEl) {
    ...
    const applyConversionRateText = () => {
      if (!conversionRateTextEl) return;
      const text = state.conversionRateText || getConversionRateText();
      if (text) conversionRateTextEl.textContent = text;
    };
    ...
    updateUsdValue();
    applyConversionRateText();

    // No inputs / dropdowns in this step, just review + confirm
