  ...
  height: 0px;
    ...
    rootEl.innerHTML = `
      <div class="canvas-wrap">
                  ...
                  <div data-sim-tab-1 class="right-container">
                    ...
                    <div class="right-slippage-container">
                      ...
                      <div class="right-slippage-input-container">
                        <div class="limit-price-input-container">
                          <div data-sim-slippage-input class="right-slippage-input-text" contenteditable="true">5.5%</div>
                          <div class="buttons-4">
        ...
        <div class="sim-toast_wrap">
          <div class="sim-toast" data-sim-toast>Change slippage to 0.5%</div>
        </div>
      </div>
    `;
    ...
    if (Cookies) {
      try {
        ...
        console.warn("[purchaseCrypto_step4] Failed to read cookie state.", e);
      }
    }
