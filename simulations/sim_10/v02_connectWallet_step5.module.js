...
.connectWalletToDex_step5_buttons.is--active .wallet-icon {
  background: #ffffff42;
  color: #fff;
}

.connectWalletToDex_step5_buttons.is--active .wallet-count,
.buttons.is--active .wallet-address, 
.buttons.is--active .btn-chev {
  color: #fff;
}

.connectWalletToDex_step5_buttons.is--active .btn-chev {
  rotate: -180deg;
}
