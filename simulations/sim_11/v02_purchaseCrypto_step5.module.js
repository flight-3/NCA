...
export default {
  mount(rootEl, props = {}, callbacks = {}) {
    ...
    if (!document.getElementById(STYLE_ID)) {
      ...
      styleEl.id = STYLE_ID;
      styleEl.textContent = `
.purchaseCrypto_step5_button-large {
  color: #fff;
  letter-spacing: -.02em;
  margin-top: 0;
  margin-bottom: 0;
...
.purchaseCrypto_step5_buttons-2 {
...
.purchaseCrypto_step5_canvas-wrap {
  grid-row-gap: 64px;
...
.purchaseCrypto_step5_container {
  grid-row-gap: 40px;
...
.purchaseCrypto_step5_container_inner {
  grid-row-gap: 24px;
  flex-direction: column;
  flex: none;
  justify-content: flex-start;
...
.purchaseCrypto_step5_container_inner::-webkit-scrollbar {
  width: 6px;
}

.purchaseCrypto_step5_container_inner::-webkit-scrollbar-track {
  background: #EDEDED;
  border-width: 6px;
  border-style: solid;
  border-color: #EDEDED;
...
.purchaseCrypto_step5_container_inner::-webkit-scrollbar-thumb {
...
.purchaseCrypto_step5_main-container-3 {
  grid-row-gap: 40px;
  flex-direction: column;
  justify-content: flex-start;
  align-items: stretch;
...
.purchaseCrypto_step5_header-container {
  grid-row-gap: 16px;
  flex-direction: column;
  justify-content: flex-start;
  align-items: stretch;
...
.purchaseCrypto_step5_title-container {
  grid-row-gap: 16px;
  flex-direction: column;
  justify-content: center;
...
.purchaseCrypto_step5_title-style {
  color: #2f2f30;
  letter-spacing: -.04em;
  margin-top: 0;
  margin-bottom: 0;
...
.purchaseCrypto_step5_button-container {
  grid-column-gap: 8px;
...
.purchaseCrypto_step5_buttons.is--active {
  color: #fff;
  background-color: #f64c07;
}

.purchaseCrypto_step5_container-2 {
  justify-content: flex-start;
  align-items: flex-start;
  min-width: 482px;
  max-width: 482px;
...
.purchaseCrypto_step5_tab-container {
  flex: 0 auto;
  justify-content: flex-start;
  align-items: flex-start;
  text-decoration: none;
...
.purchaseCrypto_step5_limit-price-container {
  grid-row-gap: 8px;
  background-color: #f9f9f9;
  border: 2px solid #ebebeb;
  border-radius: 12px;
...
.purchaseCrypto_step5_limit-price-label {
  color: #2f2f30;
  letter-spacing: -.04em;
  flex: none;
  margin-top: 0;
...
.purchaseCrypto_step5_limit-price-input-container {
...
.purchaseCrypto_step5_currency-label-container {
  grid-row-gap: 4px;
  flex-direction: column;
  justify-content: center;
  align-items: flex-start;
...
.purchaseCrypto_step5_currency-label {
  grid-column-gap: 8px;
  flex: 0 auto;
  justify-content: flex-start;
  align-items: flex-start;
...
.purchaseCrypto_step5_price-input-container {
  flex-direction: column;
  flex: 1;
  justify-content: center;
...
.purchaseCrypto_step5_price-input {
  opacity: .2;
  color: #1f1f1f;
  text-align: right;
  letter-spacing: -.04em;
...
.purchaseCrypto_step5_price-input.is--value {
  opacity: 1;
}

.purchaseCrypto_step5_price-input.is--error {
  color: #d93a3a;
  opacity: 1;
}

.purchaseCrypto_step5_market-button {
...
.purchaseCrypto_step5_selling-amount-container {
  grid-column-gap: 8px;
...
.purchaseCrypto_step5_selling-amount-label-text {
  color: #7a7a7a;
  letter-spacing: -.04em;
  margin-top: 0;
  margin-bottom: 0;
...
.purchaseCrypto_step5_selling-currency-container {
...
.purchaseCrypto_step5_selling-currency-label-text {
  color: #1f1f1f;
  letter-spacing: -.04em;
  margin-top: 0;
  margin-bottom: 0;
...
.purchaseCrypto_step5_selling-price-usd {
  opacity: .2;
  color: #1f1f1f;
  letter-spacing: -.04em;
  margin-top: 0;
...
.purchaseCrypto_step5_right-container {
  grid-row-gap: 28px;
  flex-direction: column;
  justify-content: flex-start;
  align-items: stretch;
...
.purchaseCrypto_step5_right-top-container {
  grid-row-gap: 8px;
  flex-direction: column;
  justify-content: flex-start;
  align-items: stretch;
...
.purchaseCrypto_step5_right-selling-container {
  grid-row-gap: 8px;
  background-color: #f9f9f9;
  border: 2px solid #f64c07;
  border-radius: 12px;
...
.purchaseCrypto_step5_right-slippage-container {
...
.purchaseCrypto_step5_right-slippage-input-container {
  grid-row-gap: 8px;
  background-color: #f9f9f9;
  border: 2px solid #ebebeb;
  border-radius: 12px;
...
.purchaseCrypto_step5_right-slippage-input-text {
  color: #7a7a7a;
  letter-spacing: -.04em;
  margin-top: 0;
  margin-bottom: 0;
...
.purchaseCrypto_step5_right-slippage-input-text.is--success {
  color: #16a34a;
}

.purchaseCrypto_step5_buttons-4 {
  grid-column-gap: 10px;
...
.purchaseCrypto_step5_button-large-4 {
  color: #7a7a7a;
  letter-spacing: -.02em;
  margin-top: 0;
  margin-bottom: 0;
...
.purchaseCrypto_step5_buttons-5 {
  grid-column-gap: 10px;
  background-color: #f64c07;
  border-radius: 8px;
  justify-content: center;
...
.purchaseCrypto_step5_button-large-5 {
  color: #fff;
  letter-spacing: -.02em;
  margin-top: 0;
  margin-bottom: 0;
...
.purchaseCrypto_step5_exch-ico-inner {
  flex: none;
  width: 24px;
  height: 24px;
}

.purchaseCrypto_step5_wallet-ico {
  flex: none;
  width: 16px;
  height: 16px;
}

.purchaseCrypto_step5_chev-ico {
  flex: none;
  width: 24px;
  height: 24px;
}

.purchaseCrypto_step5_container-3 {
  grid-row-gap: 40px;
  flex-direction: column;
  flex: none;
  justify-content: flex-start;
...
.purchaseCrypto_step5_info-container {
  grid-row-gap: 12px;
  flex-direction: column;
  justify-content: flex-start;
  align-items: flex-start;
...
.purchaseCrypto_step5_exchange-rate {
  color: #7a7a7a;
  letter-spacing: -.04em;
  margin-top: 0;
  margin-bottom: 0;
...
.purchaseCrypto_step5_fee-container {
  justify-content: space-between;
  align-items: center;
  width: 100%;
  text-decoration: none;
...
.purchaseCrypto_step5_fee-label {
  color: #7a7a7a;
  letter-spacing: -.04em;
  margin-top: 0;
  margin-bottom: 0;
...
.purchaseCrypto_step5_fee-value-container {
  grid-column-gap: 8px;
  flex: 0 auto;
  justify-content: flex-start;
  align-items: center;
...
.purchaseCrypto_step5_fee-value {
  color: #1f1f1f;
  letter-spacing: -.04em;
  margin-top: 0;
  margin-bottom: 0;
...
.purchaseCrypto_step5_cur-ico-img {
  object-fit: cover;
  width: 32px;
  height: 32px;
}

.purchaseCrypto_step5_sim-max-row {
  color: #7a7a7a;
  font-size: 0.75rem;
  line-height: 130%;
}
    ...
    rootEl.innerHTML = `
      <div class="purchaseCrypto_step5_canvas-wrap">
        <div data-sim-view data-sim-view-1 class="purchaseCrypto_step5_container">
          <div class="purchaseCrypto_step5_container_inner">
            <div class="purchaseCrypto_step5_main-container-3">
              <div class="purchaseCrypto_step5_header-container">
                <div class="purchaseCrypto_step5_title-container">
                  <div class="purchaseCrypto_step5_title-style">Purchase</div>
                </div>
                <div class="purchaseCrypto_step5_button-container">
                  <div class="purchaseCrypto_step5_buttons is--active">
                    <div>Market</div>
                  </div>
                  <div class="purchaseCrypto_step5_buttons">
                    <div>Limit</div>
                  </div>
                </div>
              </div>
              <div class="purchaseCrypto_step5_container-2">
                <div data-sim-tab-contain class="purchaseCrypto_step5_tab-container">
                  <div data-sim-tab-1 class="purchaseCrypto_step5_right-container">
                    <div class="purchaseCrypto_step5_right-top-container">
                      <div class="purchaseCrypto_step5_right-selling-container">
                        <div class="purchaseCrypto_step5_limit-price-input-container">
                          <div class="purchaseCrypto_step5_limit-price-label">Selling</div>
                          <div class="purchaseCrypto_step5_selling-amount-container">
                            <div class="purchaseCrypto_step5_currency-label-container">
                              <div class="purchaseCrypto_step5_currency-label">
                                <div class="purchaseCrypto_step5_selling-amount-label-text sim-max-row">
                                  Balance:
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 16 16" fill="none" class="purchaseCrypto_step5_wallet-ico">
                        ...
                        <div class="purchaseCrypto_step5_limit-price-input-container">
                          <div data-sim-selling-crypto class="purchaseCrypto_step5_selling-currency-container">
                            <div class="purchaseCrypto_step5_market-button">
                              <div data-sim-selected-selling-ico class="purchaseCrypto_step5_cur-ico">
                                <img src="https://cdn.prod.website-files.com/68f62d7ec4ced98ccbd356d8/69182e5cad7c2be8398af2e8_eth-logo.svg" class="purchaseCrypto_step5_cur-ico-img">
                              </div>
                              <div class="purchaseCrypto_step5_currency-label-container">
                                <div class="purchaseCrypto_step5_currency-label">
                                  <div data-sim-selected-selling class="purchaseCrypto_step5_selling-currency-label-text">ETH</div>
                                </div>
                              </div>
                            </div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 24 24" fill="none" class="purchaseCrypto_step5_chev-ico">
                          ...
                          <div class="purchaseCrypto_step5_price-input-container">
                            <div data-sim-selling-input class="purchaseCrypto_step5_price-input">0.00</div>
                            <div data-sim-selling-usd-value class="purchaseCrypto_step5_selling-price-usd">$0</div>
                          </div>
                        </div>
                      </div>
                      <div class="purchaseCrypto_step5_exch-ico">
                        <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 24 24" fill="none" class="purchaseCrypto_step5_exch-ico-inner">
                      ...
                      <div class="purchaseCrypto_step5_limit-price-container">
                        <div class="purchaseCrypto_step5_limit-price-input-container">
                          <div class="purchaseCrypto_step5_limit-price-label">Buying</div>
                          <div class="purchaseCrypto_step5_selling-amount-container">
                            <div class="purchaseCrypto_step5_currency-label-container">
                              <div class="purchaseCrypto_step5_currency-label">
                                <div class="purchaseCrypto_step5_selling-amount-label-text">
                        ...
                        <div class="purchaseCrypto_step5_limit-price-input-container">
                          <div data-sim-buying-crypto class="purchaseCrypto_step5_selling-currency-container">
                            <div class="purchaseCrypto_step5_market-button">
                              <div data-sim-selected-buying-ico class="purchaseCrypto_step5_cur-ico">
                                <img src="https://cdn.prod.website-files.com/68f62d7ec4ced98ccbd356d8/69182e5c5c1e6e07d92c9228_usdc-logo.svg" class="purchaseCrypto_step5_cur-ico-img">
                              </div>
                              <div class="purchaseCrypto_step5_currency-label-container">
                                <div class="purchaseCrypto_step5_currency-label">
                                  <div data-sim-selected-buying class="purchaseCrypto_step5_selling-currency-label-text">USDC</div>
                                </div>
                              </div>
                            </div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 24 24" fill="none" class="purchaseCrypto_step5_chev-ico">
                          ...
                          <div class="purchaseCrypto_step5_price-input-container">
                            <div data-sim-buying-input class="purchaseCrypto_step5_price-input">0.00</div>
                          </div>
                        </div>
                      </div>
                    </div>

                    <div class="purchaseCrypto_step5_right-slippage-container">
                      <div class="purchaseCrypto_step5_limit-price-label">Max slippage</div>
                      <div class="purchaseCrypto_step5_right-slippage-input-container">
                        <div class="purchaseCrypto_step5_limit-price-input-container">
                          <div data-sim-slippage-input class="purchaseCrypto_step5_right-slippage-input-text">0.5%</div>
                          <div class="purchaseCrypto_step5_buttons-4">
                            <div class="purchaseCrypto_step5_button-large-4">Set auto</div>
                          </div>
                        </div>
                      </div>
                    </div>

                    <div data-sim-view-2 class="purchaseCrypto_step5_container-3">
                      <div class="purchaseCrypto_step5_info-container">
                        <div data-sim-exchange-rate class="purchaseCrypto_step5_exchange-rate">
                          1 <span data-sim-selected-buying>USDC</span> = 0.00025098 <span data-sim-selected-selling>ETH</span>
                        </div>
                        <div class="purchaseCrypto_step5_fee-container">
                          <div class="purchaseCrypto_step5_fee-label">Fee (0.25%)</div>
                          <div class="purchaseCrypto_step5_fee-value-container">
                            <div data-sim-fee-value class="purchaseCrypto_step5_fee-value">&lt;$0.01</div>
                          </div>
                        </div>
                        <div class="purchaseCrypto_step5_fee-container">
                          <div class="purchaseCrypto_step5_fee-label">Network fee</div>
                          <div class="purchaseCrypto_step5_fee-value-container">
                            <div class="purchaseCrypto_step5_fee-value">0.0001 <span data-sim-network-fee>ETH</span></div>
                          </div>
                        </div>
                        <div class="purchaseCrypto_step5_fee-container">
                          <div class="purchaseCrypto_step5_fee-label">Price impact</div>
                          <div class="purchaseCrypto_step5_fee-value-container">
                            <div data-sim-price-impact class="purchaseCrypto_step5_fee-value">-0.02%</div>
                          </div>
                        </div>
                      </div>
                      <div data-sim-trigger-2 class="purchaseCrypto_step5_buttons-5">
                        <div class="purchaseCrypto_step5_button-large-5">Buy</div>
                      </div>
                    </div>
