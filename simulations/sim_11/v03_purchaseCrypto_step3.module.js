// purchaseCrypto_step3.module.js
export default {
  mount(rootEl, props = {}, callbacks = {}) {
    ...
    const STYLE_ID = "purchaseCrypto_step3_styles";

    if (!document.getElementById(STYLE_ID)) {
      const styleEl = document.createElement("style");
      styleEl.id = STYLE_ID;
      styleEl.textContent = `
.purchaseCrypto_step3_button-large {
  color: #fff;
  letter-spacing: -.02em;
  margin-top: 0;
  margin-bottom: 0;
...
.purchaseCrypto_step3_buttons-2 {
...
.purchaseCrypto_step3_canvas-wrap {
  grid-row-gap: 64px;
...
.purchaseCrypto_step3_container {
  grid-row-gap: 40px;
...
.purchaseCrypto_step3_container_inner {
  grid-row-gap: 24px;
  flex-direction: column;
  flex: none;
  justify-content: flex-start;
...
.purchaseCrypto_step3_container_inner::-webkit-scrollbar {
  width: 6px;
}

.purchaseCrypto_step3_container_inner::-webkit-scrollbar-track {
  background: #EDEDED;
  border-width: 6px;
  border-style: solid;
  border-color: #EDEDED;
...
.purchaseCrypto_step3_container_inner::-webkit-scrollbar-thumb {
...
.purchaseCrypto_step3_main-container-3 {
  grid-row-gap: 40px;
  flex-direction: column;
  justify-content: flex-start;
  align-items: stretch;
...
.purchaseCrypto_step3_header-container {
  grid-row-gap: 16px;
  flex-direction: column;
  justify-content: flex-start;
  align-items: stretch;
...
.purchaseCrypto_step3_title-container {
  grid-row-gap: 16px;
  flex-direction: column;
  justify-content: center;
...
.purchaseCrypto_step3_title-style {
  color: #2f2f30;
  letter-spacing: -.04em;
  margin-top: 0;
  margin-bottom: 0;
...
.purchaseCrypto_step3_button-container {
  grid-column-gap: 8px;
...
.purchaseCrypto_step3_buttons.is--active {
  color: #fff;
  background-color: #f64c07;
}

.purchaseCrypto_step3_container-2 {
  justify-content: flex-start;
  align-items: flex-start;
  min-width: 482px;
  max-width: 482px;
...
.purchaseCrypto_step3_tab-container {
  flex: 0 auto;
  justify-content: flex-start;
  align-items: flex-start;
  text-decoration: none;
...
.purchaseCrypto_step3_limit-price-container {
  grid-row-gap: 8px;
  background-color: #f9f9f9;
  border: 2px solid #ebebeb;
  border-radius: 12px;
...
.purchaseCrypto_step3_limit-price-label {
  color: #2f2f30;
  letter-spacing: -.04em;
  flex: none;
  margin-top: 0;
...
.purchaseCrypto_step3_limit-price-input-container {
...
.purchaseCrypto_step3_currency-label-container {
  grid-row-gap: 4px;
  flex-direction: column;
  justify-content: center;
  align-items: flex-start;
...
.purchaseCrypto_step3_currency-label {
  grid-column-gap: 8px;
  flex: 0 auto;
  justify-content: flex-start;
  align-items: flex-start;
...
.purchaseCrypto_step3_price-input-container {
  flex-direction: column;
  flex: 1;
  justify-content: center;
...
.purchaseCrypto_step3_price-input {
  opacity: .2;
  color: #1f1f1f;
  text-align: right;
  letter-spacing: -.04em;
...
.purchaseCrypto_step3_price-input.is--value {
  opacity: 1;
}

.purchaseCrypto_step3_price-input.is--error {
  color: #d93a3a;
  opacity: 1;
}

.purchaseCrypto_step3_market-button {
...
.purchaseCrypto_step3_selling-amount-container {
  grid-column-gap: 8px;
...
.purchaseCrypto_step3_selling-amount-label-text {
  color: #7a7a7a;
  letter-spacing: -.04em;
  margin-top: 0;
  margin-bottom: 0;
...
.purchaseCrypto_step3_selling-currency-container {
...
.purchaseCrypto_step3_selling-currency-label-text {
  color: #1f1f1f;
  letter-spacing: -.04em;
  margin-top: 0;
  margin-bottom: 0;
...
.purchaseCrypto_step3_selling-price-usd {
  opacity: .2;
  color: #1f1f1f;
  letter-spacing: -.04em;
  margin-top: 0;
...
.purchaseCrypto_step3_right-container {
  grid-row-gap: 28px;
  flex-direction: column;
  justify-content: flex-start;
  align-items: stretch;
...
.purchaseCrypto_step3_right-top-container {
  grid-row-gap: 8px;
  flex-direction: column;
  justify-content: flex-start;
  align-items: stretch;
...
.purchaseCrypto_step3_right-selling-container {
  grid-row-gap: 8px;
  cursor: pointer;
  background-color: #f9f9f9;
  border: 2px solid #f64c07;
...
.purchaseCrypto_step3_right-slippage-container {
...
.purchaseCrypto_step3_right-slippage-input-container {
  grid-row-gap: 8px;
  background-color: #f9f9f9;
  border: 2px solid #ebebeb;
  border-radius: 12px;
...
.purchaseCrypto_step3_right-slippage-input-text {
  color: #7a7a7a;
  letter-spacing: -.04em;
  margin-top: 0;
  margin-bottom: 0;
...
.purchaseCrypto_step3_buttons-4 {
  grid-column-gap: 10px;
...
.purchaseCrypto_step3_button-large-4 {
  color: #7a7a7a;
  letter-spacing: -.02em;
  margin-top: 0;
  margin-bottom: 0;
...
.purchaseCrypto_step3_buttons-5 {
  grid-column-gap: 10px;
  background-color: #f64c07;
  border-radius: 8px;
  justify-content: center;
...
.purchaseCrypto_step3_buttons-5.is--inactive {
  opacity: .5;
  pointer-events: none;
}

.purchaseCrypto_step3_button-large-5 {
  color: #fff;
  letter-spacing: -.02em;
  margin-top: 0;
  margin-bottom: 0;
...
.purchaseCrypto_step3_exch-ico-inner {
  flex: none;
  width: 24px;
  height: 24px;
}

.purchaseCrypto_step3_wallet-ico {
  flex: none;
  width: 16px;
  height: 16px;
}

.purchaseCrypto_step3_chev-ico {
  flex: none;
  width: 24px;
  height: 24px;
}

.purchaseCrypto_step3_container-3 {
  grid-row-gap: 40px;
  flex-direction: column;
  flex: none;
  justify-content: flex-start;
...
.purchaseCrypto_step3_container-3.is--hide {
  display: none;
}

.purchaseCrypto_step3_info-container {
  grid-row-gap: 12px;
  flex-direction: column;
  justify-content: flex-start;
  align-items: flex-start;
...
.purchaseCrypto_step3_exchange-rate {
  color: #7a7a7a;
  letter-spacing: -.04em;
  margin-top: 0;
  margin-bottom: 0;
...
.purchaseCrypto_step3_fee-container {
  justify-content: space-between;
  align-items: center;
  width: 100%;
  text-decoration: none;
...
.purchaseCrypto_step3_fee-label {
  color: #7a7a7a;
  letter-spacing: -.04em;
  margin-top: 0;
  margin-bottom: 0;
...
.purchaseCrypto_step3_fee-value-container {
  grid-column-gap: 8px;
  flex: 0 auto;
  justify-content: flex-start;
  align-items: center;
...
.purchaseCrypto_step3_fee-value {
  color: #1f1f1f;
  letter-spacing: -.04em;
  margin-top: 0;
  margin-bottom: 0;
...
.purchaseCrypto_step3_cur-ico-img {
  object-fit: cover;
  width: 32px;
  height: 32px;
}

.purchaseCrypto_step3_selection_dropdown {
  z-index: 999;
  opacity: 0;
  background-color: #fff;
  border: 2px solid #ebebeb;
...
.purchaseCrypto_step3_selection_dropdown.is--active {
  opacity: 1;
  display: flex;
}

.purchaseCrypto_step3_select_crypto-item {
  grid-column-gap: 16px;
  grid-row-gap: 16px;
  cursor: pointer;
  border-radius: 12px;
...
.purchaseCrypto_step3_select_crypto-item:hover {
  background-color: #f8f8f8;
}

.purchaseCrypto_step3_select_crypto-details {
  grid-column-gap: 12px;
  grid-row-gap: 12px;
  justify-content: flex-start;
  align-items: center;
...
.purchaseCrypto_step3_crypto-detail-name {
  color: #1f1f1f;
  font-size: 16px;
  font-weight: 600;
  line-height: 130%;
...
.purchaseCrypto_step3_crypto-detail-abbr {
  color: #7a7a7a;
  font-weight: 400;
}

.purchaseCrypto_step3_select-d-line {
...
.purchaseCrypto_step3_sim-max-row {
  color: #7a7a7a;
  font-size: 0.75rem;
  line-height: 130%;
}

.purchaseCrypto_step3_sim-toast {
  padding: 12px 20px;
  border-radius: 999px;
  background: #151515;
  color: #fff;
...
.purchaseCrypto_step3_sim-toast.is--visible {
  opacity: 1;
  transform: translateY(0);
}

.purchaseCrypto_step3_sim-toast_wrap {
  position: absolute;
  bottom: 40px;
  height: 0px;
}
    ...
    rootEl.innerHTML = `
      <div class="purchaseCrypto_step3_canvas-wrap">
        <div data-sim-view data-sim-view-1 class="purchaseCrypto_step3_container">
          <div class="purchaseCrypto_step3_container_inner">
            <div class="purchaseCrypto_step3_main-container-3">
              <div class="purchaseCrypto_step3_header-container">
                <div class="purchaseCrypto_step3_title-container">
                  <div class="purchaseCrypto_step3_title-style">Purchase</div>
                </div>
                <div class="purchaseCrypto_step3_button-container">
                  <div class="purchaseCrypto_step3_buttons is--active">
                    <div>Market</div>
                  </div>
                  <div class="purchaseCrypto_step3_buttons">
                    <div>Limit</div>
                  </div>
                </div>
              </div>
              <div class="purchaseCrypto_step3_container-2">
                <div data-sim-tab-contain class="purchaseCrypto_step3_tab-container">
                  <div data-sim-tab-1 class="purchaseCrypto_step3_right-container">
                    <div class="purchaseCrypto_step3_right-top-container">
                      <div data-sim-sell-area class="purchaseCrypto_step3_right-selling-container">
                        <div class="purchaseCrypto_step3_limit-price-input-container">
                          <div class="purchaseCrypto_step3_limit-price-label">Selling</div>
                          <div class="purchaseCrypto_step3_selling-amount-container">
                            <div class="purchaseCrypto_step3_currency-label-container">
                              <div class="purchaseCrypto_step3_currency-label">
                                <div class="purchaseCrypto_step3_selling-amount-label-text sim-max-row">
                                  Balance:
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 16 16" fill="none" class="purchaseCrypto_step3_wallet-ico">
                        ...
                        <div class="purchaseCrypto_step3_limit-price-input-container">
                          <div data-sim-selling-crypto class="purchaseCrypto_step3_selling-currency-container">
                            <div class="purchaseCrypto_step3_market-button">
                              <div data-sim-selected-selling-ico class="purchaseCrypto_step3_cur-ico">
                                <img src="https://cdn.prod.website-files.com/68f62d7ec4ced98ccbd356d8/69182e5cad7c2be8398af2e8_eth-logo.svg" class="purchaseCrypto_step3_cur-ico-img">
                              </div>
                              <div class="purchaseCrypto_step3_currency-label-container">
                                <div class="purchaseCrypto_step3_currency-label">
                                  <div data-sim-selected-selling class="purchaseCrypto_step3_selling-currency-label-text">ETH</div>
                                </div>
                              </div>
                            </div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 24 24" fill="none" class="purchaseCrypto_step3_chev-ico">
                            ...
                            <div data-sim-sell-dropdown class="purchaseCrypto_step3_selection_dropdown">
                              <div data-sim-crypto-select="btc" class="purchaseCrypto_step3_select_crypto-item">
                                <div data-sim-crypto-img class="purchaseCrypto_step3_cur-ico">
                                  <img src="https://cdn.prod.website-files.com/68f62d7ec4ced98ccbd356d8/69182e5cdc09e9e742cbdff5_btc-logo.svg" class="purchaseCrypto_step3_cur-ico-img">
                                </div>
                                <div class="purchaseCrypto_step3_select_crypto-details">
                                  <div class="purchaseCrypto_step3_crypto-detail-name">Bitcoin</div>
                                  <div data-sim-crypto-name class="purchaseCrypto_step3_crypto-detail-abbr">BTC</div>
                                </div>
                              </div>
                              <div class="purchaseCrypto_step3_select-d-line"></div>
                              <div data-sim-crypto-select="eth" class="purchaseCrypto_step3_select_crypto-item">
                                <div data-sim-crypto-img class="purchaseCrypto_step3_cur-ico">
                                  <img src="https://cdn.prod.website-files.com/68f62d7ec4ced98ccbd356d8/69182e5cad7c2be8398af2e8_eth-logo.svg" class="purchaseCrypto_step3_cur-ico-img">
                                </div>
                                <div class="purchaseCrypto_step3_select_crypto-details">
                                  <div class="purchaseCrypto_step3_crypto-detail-name">Ethereum</div>
                                  <div data-sim-crypto-name class="purchaseCrypto_step3_crypto-detail-abbr">ETH</div>
                                </div>
                              </div>
                              <div class="purchaseCrypto_step3_select-d-line"></div>
                              <div data-sim-crypto-select="xrp" class="purchaseCrypto_step3_select_crypto-item">
                                <div data-sim-crypto-img class="purchaseCrypto_step3_cur-ico">
                                  <img src="https://cdn.prod.website-files.com/68f62d7ec4ced98ccbd356d8/69182e5cecd803e93aa1a9d1_xrp-logo.svg" class="purchaseCrypto_step3_cur-ico-img">
                                </div>
                                <div class="purchaseCrypto_step3_select_crypto-details">
                                  <div class="purchaseCrypto_step3_crypto-detail-name">XRP</div>
                                  <div data-sim-crypto-name class="purchaseCrypto_step3_crypto-detail-abbr">XRP</div>
                                </div>
                              </div>
                              <div class="purchaseCrypto_step3_select-d-line"></div>
                              <div data-sim-crypto-select="bnb" class="purchaseCrypto_step3_select_crypto-item">
                                <div data-sim-crypto-img class="purchaseCrypto_step3_cur-ico">
                                  <img src="https://cdn.prod.website-files.com/68f62d7ec4ced98ccbd356d8/69182e5c63efaa27da6d1b15_bnb-logo.svg" class="purchaseCrypto_step3_cur-ico-img">
                                </div>
                                <div class="purchaseCrypto_step3_select_crypto-details">
                                  <div class="purchaseCrypto_step3_crypto-detail-name">BNB</div>
                                  <div data-sim-crypto-name class="purchaseCrypto_step3_crypto-detail-abbr">BNB</div>
                                </div>
                              </div>
                              <div class="purchaseCrypto_step3_select-d-line"></div>
                              <div data-sim-crypto-select="usdc" class="purchaseCrypto_step3_select_crypto-item">
                                <div data-sim-crypto-img class="purchaseCrypto_step3_cur-ico">
                                  <img src="https://cdn.prod.website-files.com/68f62d7ec4ced98ccbd356d8/69182e5c5c1e6e07d92c9228_usdc-logo.svg" class="purchaseCrypto_step3_cur-ico-img">
                                </div>
                                <div class="purchaseCrypto_step3_select_crypto-details">
                                  <div class="purchaseCrypto_step3_crypto-detail-name">USDC</div>
                                  <div data-sim-crypto-name class="purchaseCrypto_step3_crypto-detail-abbr">USDC</div>
                                </div>
                              </div>
                            </div>
                          </div>
                          <div class="purchaseCrypto_step3_price-input-container">
                            <div data-sim-selling-input class="purchaseCrypto_step3_price-input" tabindex="0" contenteditable="true">0.00</div>
                            <div data-sim-selling-usd-value class="purchaseCrypto_step3_selling-price-usd">$0</div>
                          </div>
                        </div>
                      </div>
                      <div class="purchaseCrypto_step3_exch-ico">
                        <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 24 24" fill="none" class="purchaseCrypto_step3_exch-ico-inner">
                      ...
                      <div data-sim-buy-area class="purchaseCrypto_step3_limit-price-container">
                        <div class="purchaseCrypto_step3_limit-price-input-container">
                          <div class="purchaseCrypto_step3_limit-price-label">Buying</div>
                          <div class="purchaseCrypto_step3_selling-amount-container">
                            <div class="purchaseCrypto_step3_currency-label-container">
                              <div class="purchaseCrypto_step3_currency-label">
                                <div class="purchaseCrypto_step3_selling-amount-label-text">
                        ...
                        <div class="purchaseCrypto_step3_limit-price-input-container">
                          <div data-sim-buying-crypto class="purchaseCrypto_step3_selling-currency-container">
                            <div class="purchaseCrypto_step3_market-button">
                              <div data-sim-selected-buying-ico class="purchaseCrypto_step3_cur-ico">
                                <img src="https://cdn.prod.website-files.com/68f62d7ec4ced98ccbd356d8/69182e5c5c1e6e07d92c9228_usdc-logo.svg" class="purchaseCrypto_step3_cur-ico-img">
                              </div>
                              <div class="purchaseCrypto_step3_currency-label-container">
                                <div class="purchaseCrypto_step3_currency-label">
                                  <div data-sim-selected-buying class="purchaseCrypto_step3_selling-currency-label-text">USDC</div>
                                </div>
                              </div>
                            </div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 24 24" fill="none" class="purchaseCrypto_step3_chev-ico">
                            ...
                            <div data-sim-buy-dropdown class="purchaseCrypto_step3_selection_dropdown">
                              <div data-sim-crypto-select="btc" class="purchaseCrypto_step3_select_crypto-item">
                                <div data-sim-crypto-img class="purchaseCrypto_step3_cur-ico">
                                  <img src="https://cdn.prod.website-files.com/68f62d7ec4ced98ccbd356d8/69182e5cdc09e9e742cbdff5_btc-logo.svg" class="purchaseCrypto_step3_cur-ico-img">
                                </div>
                          ...
                          <div class="purchaseCrypto_step3_price-input-container">
                            <div data-sim-buying-input class="purchaseCrypto_step3_price-input" tabindex="0" contenteditable="true">0.00</div>
                          </div>
                        </div>
                      </div>
                    </div>

                    <div class="purchaseCrypto_step3_right-slippage-container">
                      <div class="purchaseCrypto_step3_limit-price-label">Max slippage</div>
                      <div class="purchaseCrypto_step3_right-slippage-input-container">
                        <div class="purchaseCrypto_step3_limit-price-input-container">
                          <div data-sim-slippage-input class="purchaseCrypto_step3_right-slippage-input-text">5.5%</div>
                          <div class="purchaseCrypto_step3_buttons-4">
                            <div class="purchaseCrypto_step3_button-large-4">Set auto</div>
                          </div>
                        </div>
                      </div>
                    </div>

                    <div data-sim-trigger-1 class="purchaseCrypto_step3_buttons-5 is--inactive">
                      <div class="purchaseCrypto_step3_button-large-5">Enter amount</div>
                    </div>

                    <div data-sim-view-2 class="purchaseCrypto_step3_container-3 is--hide">
                      <div class="purchaseCrypto_step3_info-container">
                        <div data-sim-exchange-rate class="purchaseCrypto_step3_exchange-rate">
                          1 <span data-sim-selected-buying>USDC</span> = 0.00025098 <span data-sim-selected-selling>ETH</span>
                        </div>
                        <div class="purchaseCrypto_step3_fee-container">
                          <div class="purchaseCrypto_step3_fee-label">Fee (0.25%)</div>
                          <div class="purchaseCrypto_step3_fee-value-container">
                            <div data-sim-fee-value class="purchaseCrypto_step3_fee-value">&lt;$0.01</div>
                          </div>
                        </div>
                        <div class="purchaseCrypto_step3_fee-container">
                          <div class="purchaseCrypto_step3_fee-label">Network fee</div>
                          <div class="purchaseCrypto_step3_fee-value-container">
                            <div data-sim-network-fee class="purchaseCrypto_step3_fee-value">0.0001 ETH</div>
                          </div>
                        </div>
                        <div class="purchaseCrypto_step3_fee-container">
                          <div class="purchaseCrypto_step3_fee-label">Price impact</div>
                          <div class="purchaseCrypto_step3_fee-value-container">
                            <div data-sim-price-impact class="purchaseCrypto_step3_fee-value">-0.02%</div>
                          </div>
                        </div>
                      </div>
                      <div data-sim-trigger-2 class="purchaseCrypto_step3_buttons-5 is--inactive">
                        <div class="purchaseCrypto_step3_button-large-5">Buy</div>
                      </div>
                    </div>
        ...
        <div class="purchaseCrypto_step3_sim-toast_wrap">
        <div class="purchaseCrypto_step3_sim-toast" data-sim-toast>Cannot sell more than your wallet balance.</div>
      </div>
      </div>
    `;
    ...
    if (
      ...
      console.warn("[purchaseCrypto_step3] Missing required elements.");
      return;
    }
...
const persistState = () => {
  try {
    ...
    // Fetch live USD prices from CoinGecko (overwrites prices map)
    const fetchLatestUsdRates = async () => {
      ...
      try {
        ...
        console.warn(
          "[purchaseCrypto_step3] Failed to fetch live prices from CoinGecko; using default prices.",
          err
        );
      }
    };
    ...
    // Fetch live prices now + refresh hourly
    fetchLatestUsdRates();
