  ...
  height: 0px;
    ...
    rootEl.innerHTML = `
      <div class="canvas-wrap">
                  ...
                  <div data-sim-tab-1 class="right-container">
                    ...
                    <div class="right-slippage-container">
                      ...
                      <div class="right-slippage-input-container">
                        <div class="limit-price-input-container">
                          <div data-sim-slippage-input class="right-slippage-input-text">5.5%</div>
                          <div class="buttons-4">
                    ...
                    <div data-sim-view-2 class="container-3 is--hide">
                      <div class="info-container">
                        ...
                        <div class="fee-container">
                          ...
                          <div class="fee-value-container">
                            <div data-sim-network-fee class="fee-value">0.0001 ETH</div>
                          </div>
                        </div>
                        <div class="fee-container">
                      ...
                      <div data-sim-trigger-2 class="buttons-5 is--inactive">
        ...
        <div class="sim-toast" data-sim-toast>Cannot sell more than your wallet balance.</div>
      </div>
      </div>
    `;
