...
.swapCrypto_step5_container-fauxui {
  grid-row-gap: 24px;
...
.swapCrypto_step5_container-fauxui.is--alt {
  pointer-events: none;
...
.swapCrypto_step5_container-main {
  grid-row-gap: 40px;
  background-color: #fff;
...
.swapCrypto_step5_container-inner {
  grid-row-gap: 32px;
  flex-direction: column;
  justify-content: flex-start;
  align-items: center;
...
.swapCrypto_step5_container-content {
  grid-row-gap: 24px;
  flex-direction: column;
  justify-content: flex-start;
...
.swapCrypto_step5_container-crypto {
  grid-row-gap: 12px;
  flex-direction: column;
  justify-content: flex-start;
  align-items: stretch;
...
.swapCrypto_step5_crypto .text-2 {
  font-size: 1.2rem;
}

.swapCrypto_step5_crypto-text {
  flex-direction: column;
  justify-content: flex-start;
  align-items: flex-start;
  text-decoration: none;
...
.swapCrypto_step5_amount-in-usd {
  opacity: .2;
  color: #1f1f1f;
  letter-spacing: -.04em;
  margin-top: 0;
...
.swapCrypto_step5_label-style-3 {
  grid-row-gap: 4px;
  flex-direction: column;
  justify-content: center;
  align-items: flex-start;
...
.swapCrypto_step5_container-details {
  grid-row-gap: 8px;
  flex-direction: column;
  justify-content: flex-start;
  align-items: flex-start;
...
.swapCrypto_step5_label-style-4 {
  color: #7a7a7a;
  letter-spacing: -.04em;
  margin-top: 0;
  margin-bottom: 0;
...
.swapCrypto_step5_container-btn-wrap {
...
.swapCrypto_step5_button-large-2 {
  color: #7a7a7a;
  letter-spacing: -.02em;
  margin-top: 0;
  margin-bottom: 0;
...
.swapCrypto_step5_button-large-3 {
  color: #fff;
  letter-spacing: -.02em;
  margin-top: 0;
  margin-bottom: 0;
...
.swapCrypto_step5_crypto_ico img {
  width: 32px;
  height: 32px;
  object-fit: cover;
  border-radius: 100%;
...
.swapCrypto_step5_edit-ico {
  flex: none;
  width: 20px;
  height: 20px;
}

.swapCrypto_step5_fauxui {
  background-color: #ebebeb;
  border-radius: 8px;
  height: 70px;
}

.swapCrypto_step5_fauxui.is--alt {
  height: 24px;
  margin-bottom: 0;
}

.swapCrypto_step5_fauxui.is--alt2 {
  width: 50%;
  height: 70px;
  margin-top: 32px;
}

.swapCrypto_step5_crypto_ico.is--usdc,
.swapCrypto_step5_crypto_ico.is--usdt {
position: relative;
    }
...
overflow: hidden;}
    ...
    // Static HTML
    rootEl.innerHTML = `
      <div class="swapCrypto_step5_canvas-wrap">
        <div data-sim-view-1 class="swapCrypto_step5_container">
          <div class="swapCrypto_step5_container-fauxui is--alt">
            <div class="swapCrypto_step5_fauxui"></div>
            <div class="swapCrypto_step5_fauxui is--alt"></div>
            <div class="swapCrypto_step5_fauxui is--alt"></div>
            <div class="swapCrypto_step5_fauxui is--alt"></div>
            <div class="swapCrypto_step5_fauxui is--alt2"></div>
            <div class="swapCrypto_step5_fauxui is--alt"></div>
            <div class="swapCrypto_step5_fauxui is--alt"></div>
          </div>
          <div class="swapCrypto_step5_container-fauxui"></div>
          <div data-sim-view-2 class="swapCrypto_step5_container-main">
            <div class="swapCrypto_step5_container-inner">
              <div class="swapCrypto_step5_title-el">Transaction request</div>
              <div class="swapCrypto_step5_container-content">
                <div class="swapCrypto_step5_container-crypto">
                  <div class="swapCrypto_step5_crypto-el">
                    <div class="swapCrypto_step5_label-el">
                      <div class="swapCrypto_step5_text">You send</div>
                    </div>
                    <div class="swapCrypto_step5_container-sb">
                      <div data-sim-selling-crypto class="swapCrypto_step5_crypto">
                        <div data-sim-selected-selling-ico class="swapCrypto_step5_crypto_ico"></div>
                        <div class="swapCrypto_step5_crypto-text">
                          <div data-sim-selected-selling class="swapCrypto_step5_text-2">USDC</div>
                        </div>
                      </div>
                      <div class="swapCrypto_step5_container-11">
                        <div data-sim-selling-input class="swapCrypto_step5_amount">10.00</div>
                        <div class="swapCrypto_step5_amount-in-usd">$10.00</div>
                      </div>
                    </div>
                  </div>
                  <div class="swapCrypto_step5_crypto-el">
                    <div class="swapCrypto_step5_label-el">
                      <div class="swapCrypto_step5_text">You receive</div>
                    </div>
                    <div class="swapCrypto_step5_container-sb">
                      <div data-sim-buying-crypto class="swapCrypto_step5_crypto">
                        <div data-sim-selected-buying-ico class="swapCrypto_step5_crypto_ico">
                        </div>
                        <div class="swapCrypto_step5_label-style-3">
                          <div class="swapCrypto_step5_container-12">
                            <div data-sim-selected-buying class="swapCrypto_step5_text-2">ETH</div>
                          </div>
                        </div>
                      </div>
                      <div class="swapCrypto_step5_container-11">
                        <div data-sim-buying-input class="swapCrypto_step5_amount">0.002524</div>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="swapCrypto_step5_container-details">
                  <div class="swapCrypto_step5_container-sb">
                    <div class="swapCrypto_step5_label-style-4">Network</div>
                    <div data-sim-buying-network class="swapCrypto_step5_text-2">Ethereum</div>
                  </div>
                  <div class="swapCrypto_step5_container-sb">
                    <div class="swapCrypto_step5_label-style-4">Network fee</div>
                    <div class="swapCrypto_step5_container-14">
                      <div class="swapCrypto_step5_text-2">
                        <span data-sim-network-fee-amount>0.0001</span>
                        <span data-sim-selected-selling>ETH</span>
                      </div>
                      <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 20 20" fill="none" class="swapCrypto_step5_edit-ico">
                  ...
                  <div class="swapCrypto_step5_container-sb">
                    <div class="swapCrypto_step5_label-style-4">Speed</div>
                    <div class="swapCrypto_step5_container-14">
                      <div class="swapCrypto_step5_text-2">Low - 12 sec</div>
                      <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 20 20" fill="none" class="swapCrypto_step5_edit-ico">
                        <path d="M17.4993 10.0003C17.2783 10.0003 17.0664 10.0881 16.9101 10.2444C16.7538 10.3606 16.666 10.6126 16.666 10.8336V15.8336C16.666 16.0546 16.5782 16.2666 16.4219 16.4229C16.2657 16.5791 16.0537 16.6669 15.8327 16.6669H4.16602C3.945 16.6669 3.73304 16.5791 3.57676 16.4229C3.42048 16.2666 3.33268 16.0546 3.33268 15.8336V4.16694C3.33268 3.94593 3.42048 3.73397 3.57676 3.57769C3.73304 3.42141 3.945 3.33361 4.16602 3.33361H9.16602C9.38703 3.33361 9.59899 3.24581 9.75527 3.08953C9.91155 2.93325 9.99935 2.72129 9.99935 2.50027C9.99935 2.27926 9.91155 2.0673 9.75527 1.91102C9.59899 1.75474 9.38703 1.66694 9.16602 1.66694H4.16602C3.50297 1.66694 2.86709 1.93033 2.39825 2.39917C1.92941 2.86802 1.66602 3.5039 1.66602 4.16694V15.8336C1.66602 16.4966 1.92941 17.1325 2.39825 17.6014C2.86709 18.0702 3.50297 18.3336 4.16602 18.3336H15.8327C16.4957 18.3336 17.1316 18.0702 17.6005 17.6014C18.0693 17.1325 18.3327 16.4966 18.3327 15.8336V10.8336C18.3327 10.6126 18.2449 10.3606 18.0886 10.2444C17.9323 10.0881 17.7204 10.0003 17.4993 10.0003ZM4.99935 10.6336V14.1669C4.99935 14.388 5.08715 14.5999 5.24343 14.7562C5.39971 14.9125 5.61167 15.0003 5.83268 15.0003H9.36602C9.47569 15.0009 9.58441 14.9799 9.68594 14.9384C9.78747 14.8969 9.87982 14.8358 9.95768 14.7586L15.7244 8.98361L18.091 6.66694C18.1691 6.58947 18.2311 6.4973 18.2734 6.39576C18.3157 6.29421 18.3375 6.18528 18.3375 6.07527C18.3375 5.96526 18.3157 5.85634 18.2734 5.75479C18.2311 5.65324 18.1691 5.56108 18.091 5.48361L14.5577 1.90861C14.4802 1.8305 14.388 1.76851 14.2865 1.7262C14.1849 1.68389 14.076 1.66211 13.966 1.66211C13.856 1.66211 13.7471 1.68389 13.6455 1.7262C13.544 1.76851 13.4518 1.8305 13.3743 1.90861L11.0243 4.26694L5.24102 10.0419C5.16378 10.1198 5.10268 10.2122 5.06121 10.3137C5.01974 10.4152 4.99872 10.5239 4.99935 10.6336V10.6336ZM13.966 3.67527L16.3243 6.03361L15.141 7.21694L12.7827 4.85861L13.966 3.67527ZM6.66602 10.9753L11.6077 6.03361L13.966 8.39194L9.02435 13.3336H6.66602V10.9753Z" fill="#7A7A7A"></path>
                      </svg>
                    </div>
                  ...
                  <div class="swapCrypto_step5_container-sb">
                    <div class="swapCrypto_step5_label-style-4">Minimum Received</div>
                    <div class="swapCrypto_step5_text-2">
              ...
              <div class="swapCrypto_step5_container-btn-wrap">
                <div class="swapCrypto_step5_buttons">
                  <div class="swapCrypto_step5_button-large-2">Reject</div>
                </div>
                <div data-sim-trigger-1 class="swapCrypto_step5_buttons-3">
                  <div class="swapCrypto_step5_button-large-3">Confirm</div>
                </div>
              </div>
            </div>
          </div>
    ...
    const view1In = rootEl.querySelector(".swapCrypto_step5_container-fauxui");
    ...
    const amountInUsdEl = rootEl.querySelector(
      ".swapCrypto_step5_amount-in-usd",
    );
    ...
    const syncSelectedLabelsAndIcons = () => {
      ...
      if (buyCrypto) {
        ...
        if (buyingIconWrap) {
          buyingIconWrap.classList.remove("is--usdc", "is--usdt");
          buyingIconWrap.innerHTML = "";

          const isStablecoin =
            buyCrypto.symbol === "USDC" || buyCrypto.symbol === "USDT";

          if (buyCrypto.symbol === "USDC") {
            buyingIconWrap.classList.add("is--usdc");
          } else if (buyCrypto.symbol === "USDT") {
            buyingIconWrap.classList.add("is--usdt");
          }
          ...
          if (isStablecoin) {
            ...
            innerIcon.className = "inner-ico";
            innerIcon.setAttribute("data-sim-selected-selling-ico", "");

            const sellingImg = sellingIconWrap?.querySelector("img");

            if (sellingImg) {
              innerIcon.appendChild(sellingImg.cloneNode(true));
            }

            buyingIconWrap.appendChild(innerIcon);
          }
        }
      }
    };
