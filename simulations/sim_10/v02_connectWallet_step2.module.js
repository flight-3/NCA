...
export default {
  mount(rootEl, props = {}, callbacks = {}) {
    ...
    if (!document.getElementById(STYLE_ID)) {
      ...
      styleEl.id = STYLE_ID;
      styleEl.textContent = `
.connectWalletDex_step2_button-large {
  color: #fff;
  letter-spacing: -.02em;
  margin-top: 0;
  margin-bottom: 0;
...
.connectWalletDex_step2_buttons-2 {
...
.connectWalletDex_step2_main-container {
  grid-column-gap: 10px;
  justify-content: center;
  align-items: center;
  width: 100%;
...
.connectWalletDex_step2_canvas-wrap {
...
.connectWalletDex_step2_container {
  grid-row-gap: 40px;
...
.connectWalletDex_step2_title-style {
  color: #2f2f30;
  letter-spacing: -.04em;
  width: 100%;
  margin-top: 0;
...
.connectWalletDex_step2_container-2 {
  grid-row-gap: 16px;
  flex-direction: column;
  justify-content: flex-start;
  align-items: stretch;
...
.connectWalletDex_step2_container-3 {
  grid-column-gap: 10px;
  cursor: pointer;
...
.connectWalletDex_step2_container-3:hover {
  background-color: #f64c071f;
}

.connectWalletDex_step2_container-4 {
...
.connectWalletDex_step2_wallet-type {
  color: #1f1f1f;
  letter-spacing: -.04em;
  font-size: 1.25rem;
  font-weight: 500;
...
.connectWalletDex_step2_container-5 {
  grid-column-gap: 24px;
  background-color: #f9f9f9;
...
.connectWalletDex_step2_container-6 {
  background-color: #f9f9f9;
  border: 1px solid #ebebeb;
  border-radius: 12px;
  flex: none;
...
.connectWalletDex_step2_container-7 {
  grid-column-gap: 24px;
  background-color: #1f1f1f1a;
  border-radius: 8px;
  flex: 0 auto;
...
.connectWalletDex_step2_wallet-count {
  color: #7a7a7a;
  letter-spacing: -.04em;
  margin-top: 0;
  margin-bottom: 0;
...
.connectWalletDex_step2_container-8 {
  grid-row-gap: 32px;
  background-color: #fff;
  border-radius: 20px;
  flex-direction: column;
...
.connectWalletDex_step2_title-style-2 {
  color: #2f2f30;
  text-align: center;
  letter-spacing: -.04em;
  width: 100%;
...
.connectWalletDex_step2_qr-code-container {
  grid-row-gap: 24px;
  flex-direction: column;
  justify-content: flex-start;
  align-items: center;
...
.connectWalletDex_step2_qr-code-image {
  object-fit: cover;
}

.connectWalletDex_step2_instruction {
  color: #7a7a7a;
  text-align: center;
  letter-spacing: -.04em;
  width: 100%;
...
.connectWalletDex_step2_link-container {
  grid-column-gap: 8px;
  background-color: #1f1f1f1a;
  border-radius: 8px;
  flex: 0 auto;
...
.connectWalletDex_step2_link-text {
  color: #7a7a7a;
  letter-spacing: -.04em;
  margin-top: 0;
  margin-bottom: 0;
  ...
  text-decoration: none;
    ...
    // ----------------------------------
    rootEl.innerHTML = `
      <div class="connectWalletDex_step2_canvas-wrap">
        <div data-sim-view-1 class="connectWalletDex_step2_container">
          <div class="connectWalletDex_step2_title-style">Connect Wallet</div>
          <div class="connectWalletDex_step2_container-2">
            <div data-sim-trigger class="connectWalletDex_step2_container-3">
              <div class="connectWalletDex_step2_container-4">
                <div class="connectWalletDex_step2_btc"></div>
                <div class="connectWalletDex_step2_wallet-type">Wallet type 1</div>
              </div>
            </div>
            <div class="connectWalletDex_step2_container-5">
              <div class="connectWalletDex_step2_container-4">
                <div class="connectWalletDex_step2_btc-2"></div>
                <div class="connectWalletDex_step2_wallet-type">Wallet type 2</div>
              </div>
            </div>
            <div class="connectWalletDex_step2_container-5">
              <div class="connectWalletDex_step2_container-4">
                <div class="connectWalletDex_step2_btc-3"></div>
                <div class="connectWalletDex_step2_wallet-type">Wallet type 3</div>
              </div>
            </div>
            <div class="connectWalletDex_step2_container-6">
              <div class="connectWalletDex_step2_container-4">
                <div class="connectWalletDex_step2_btc-4">
                  <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 24 24" fill="none" class="connectWalletDex_step2_icon">
                ...
                <div class="connectWalletDex_step2_wallet-type">All Wallets</div>
              </div>
              <div class="connectWalletDex_step2_container-7">
                <div class="connectWalletDex_step2_wallet-count">50+</div>
              </div>
            </div>
          </div>

          <div data-sim-view-2 class="connectWalletDex_step2_container-8">
            <div class="connectWalletDex_step2_title-style-2">Wallet type 1</div>
            <div class="connectWalletDex_step2_qr-code-container">
              <div class="connectWalletDex_step2_qr-code">
                <img src="https://cdn.prod.website-files.com/68f62d7ec4ced98ccbd356d8/69284e1bcce49eed93427489_SimQR.png" loading="auto" width="232" height="232" alt="" class="connectWalletDex_step2_qr-code-image">
              </div>
              <div class="connectWalletDex_step2_instruction">Scan this QR Code with your phone</div>
            </div>
            <div class="connectWalletDex_step2_link-container">
              <div class="connectWalletDex_step2_link-text">Copy link</div>
              <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 20 20" fill="none" class="connectWalletDex_step2_icon">
