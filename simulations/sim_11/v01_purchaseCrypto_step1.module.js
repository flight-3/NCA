...
@keyframes shadow-drop-center {
  ...
  100% {
    ...
    rootEl.innerHTML = `
      <div class="pc-step1-wrap">
        <div data-pc-view="1" class="canvas-wrap-step1">
          <div class="step1content">
            <div class="fauxui_header">
              <div class="fauxui_06"></div>
              <div class="fauxui_05"></div>
              <div data-pc-trigger-connect class="buttons">
        ...
        <div data-pc-view="2" class="canvas-wrap-step2">
          <div class="main-container">
            <div class="container">
              <div class="title-style">Connect Wallet</div>
              <div class="container-2">
                <div data-pc-trigger-wallet class="container-3">
                  <div class="container-4_alt">
                    <div class="btc"></div>
              ...
              <div data-pc-view="2-qr" class="container-8">
        ...
        <div data-pc-view="3" class="canvas-wrap-step3">
          <div class="container-phone">
            <div data-pc-modal-connect class="modal">
              ...
              <div class="actions">
                <div class="buttons-3">
                  <div class="button-large-2-alt">Cancel</div>
                </div>
                <div data-pc-trigger-connect-confirm class="buttons-4">
                  <div class="button-large-3">Connect</div>
                </div>
              </div>
            </div>

            <div data-pc-modal-signature class="modal is--2">
              <div class="container-2-alt">
              ...
              <div class="actions">
                ...
                <div data-pc-trigger-signature-confirm class="buttons-4">
          ...
          <div data-pc-loader class="container-3-loader">
