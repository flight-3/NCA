      ...
      <div class="nca-step8_wrap">
        <div class="nca-step8_card" data-sim-main-view>
          ...
          <div class="nca-step8_scan-screen" data-sim-scan-screen>
            <img src="https://cdn.prod.website-files.com/68f62d7ec4ced98ccbd356d8/69162fa95ba50cacbc2debea_KYC-photo.webp" loading="auto" alt="" class="nca-step8_scan-img" />
    ...
    const startScanFlow = () => {
      ...
      if (gs) {
        ...
        tl.set(scanScreen, { display: "flex" })
          ...
          .fromTo(scanLine, { y: 0 }, { y: 260, duration: 1.4 }, "+=0.1")
          .to(scanLine, {
            y: 30,
            duration: 1.4,
          })
