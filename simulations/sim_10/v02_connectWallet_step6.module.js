// connectWalletToDex_step6.module.js
export default {
  mount(rootEl, props = {}, callbacks = {}) {
    ...
    if (!rootEl) {
      console.warn("[connectWalletToDex_step6] mount called without rootEl");
      done?.();
      return;
    }

    const STYLE_ID = "connectWalletToDex_step6_styles";

    if (!document.getElementById(STYLE_ID)) {
      const styleEl = document.createElement("style");
      styleEl.id = STYLE_ID;
      styleEl.textContent = `
.connectWalletToDex_step6_button-large {
  color: #fff;
  letter-spacing: -.02em;
  margin-top: 0;
  margin-bottom: 0;
...
.connectWalletToDex_step6_buttons-2 {
...
.connectWalletToDex_step6_canvas-wrap {
...
.connectWalletToDex_step6_container {
  grid-row-gap: 40px;
...
.connectWalletToDex_step6_container-2 {
...
.connectWalletToDex_step6_fauxui {
  opacity: .1;
...
.connectWalletToDex_step6_fauxui-2 {
  opacity: .1;
  background-color: #6f6f6f;
  border-radius: 8px;
  flex: 1;
...
.connectWalletToDex_step6_buttons {
...
.connectWalletToDex_step6_buttons.is--active {
  background: #f64c07;
}

.connectWalletToDex_step6_buttons.is--active .wallet-icon {
  background: #ffffff42;
  color: #fff;
}

.connectWalletToDex_step6_buttons.is--active .wallet-count,
.buttons.is--active .wallet-address, 
.buttons.is--active .btn-chev {
  color: #fff;
}

.connectWalletToDex_step6_buttons.is--active .btn-chev {
  rotate: -180deg;
}

.connectWalletToDex_step6_wallet-info {
  grid-column-gap: 16px;
  flex: 0 auto;
  justify-content: flex-start;
  align-items: center;
...
.connectWalletToDex_step6_wallet-icon {
  grid-column-gap: 10px;
  color: #7a7a7a;
...
.connectWalletToDex_step6_wallet-icon-image {
  object-fit: cover;
  overflow: hidden;
}

.connectWalletToDex_step6_wallet-details {
  flex-direction: column;
  justify-content: flex-start;
...
.connectWalletToDex_step6_wallet-count {
  color: #1f1f1f;
  letter-spacing: -.02em;
  margin-top: 0;
  margin-bottom: 0;
...
.connectWalletToDex_step6_wallet-address {
  opacity: .8;
  color: #7a7a7a;
  letter-spacing: -.02em;
  margin-top: 0;
...
.connectWalletToDex_step6_container-3 {
  grid-row-gap: 64px;
  flex-direction: column;
  justify-content: flex-start;
  align-items: stretch;
...
.connectWalletToDex_step6_container-4 {
  grid-row-gap: 24px;
  flex-direction: column;
  flex: 1;
  justify-content: flex-start;
...
.connectWalletToDex_step6_fauxui-3 {
...
.connectWalletToDex_step6_container-5 {
...
.connectWalletToDex_step6_fauxui-4 {
...
.connectWalletToDex_step6_fauxui-5 {
  background-image: linear-gradient(270deg, #f7f7f7, #ededed);
  border-radius: 8px;
  flex: 1;
}

.connectWalletToDex_step6_fauxui-6 {
  background-image: linear-gradient(270deg, #ededed, #f7f7f7);
  border-top-right-radius: 8px;
  flex: 1;
}

.connectWalletToDex_step6_wallet-ico {
  width: 20px;
  height: 20px;
  transition: all 0.735s cubic-bezier(0.65, 0.05, 0, 1);
}

.connectWalletToDex_step6_btn-chev {
  color: #7a7a7a;
  width: 24px;
  height: 24px;
  transition: all 0.735s cubic-bezier(0.65, 0.05, 0, 1);
...
.connectWalletToDex_step6_btn-chev.is--dd {
  opacity: .8;
  width: 20px;
  height: 20px;
}

.connectWalletToDex_step6_dropdown_wrap {
  width: 80%;
  max-width: 80%;
  position: absolute;
  top: 100%;
...
.connectWalletToDex_step6_container-6 {
...
.connectWalletToDex_step6_container-7 {
  grid-row-gap: 40px;
  background-color: #fff;
  border-radius: 20px;
  flex-direction: column;
...
.connectWalletToDex_step6_header-style {
  justify-content: space-between;
  align-items: center;
  display: flex;
}

.connectWalletToDex_step6_title-style {
  color: #2f2f30;
  letter-spacing: -.04em;
  margin-top: 0;
  margin-bottom: 0;
...
.connectWalletToDex_step6_buttons-3 {
  grid-column-gap: 4px;
...
.connectWalletToDex_step6_add-icon {
  object-fit: cover;
  overflow: hidden;
}

.connectWalletToDex_step6_add-button {
  color: #7a7a7a;
  letter-spacing: -.02em;
  margin-top: 0;
  margin-bottom: 0;
...
.connectWalletToDex_step6_wallet-list {
  grid-row-gap: 12px;
  flex-direction: column;
  justify-content: flex-start;
  align-items: stretch;
...
.connectWalletToDex_step6_wallet-info-header {
  grid-column-gap: 0px;
  flex: 0 auto;
  justify-content: flex-start;
  align-items: flex-start;
...
.connectWalletToDex_step6_wallet-label {
  opacity: .8;
  color: #7a7a7a;
  letter-spacing: -.02em;
  margin-top: 0;
...
.connectWalletToDex_step6_wallet-label.is--alt-2 {
  width: 120px;
}

.connectWalletToDex_step6_checkbtn {
  cursor: pointer;
...
.connectWalletToDex_step6_wallet-icon-2 {
  object-fit: cover;
}

.connectWalletToDex_step6_wallet-name {
  color: #1f1f1f;
  letter-spacing: -.02em;
  margin-top: 0;
  margin-bottom: 0;
...
.connectWalletToDex_step6_wallet-address-container {
  grid-column-gap: 8px;
  flex: 0 auto;
  justify-content: center;
  align-items: center;
...
.connectWalletToDex_step6_copy-icon {
  opacity: .8;
  object-fit: cover;
  overflow: hidden;
}

.connectWalletToDex_step6_network-container {
  grid-column-gap: 8px;
...
.connectWalletToDex_step6_logoutbtn {
  grid-column-gap: 8px;
  background-color: #1f1f1f0d;
  color: #7a7a7a;
  border: 1px solid #ebebeb;
...
.connectWalletToDex_step6_logoutbtn.is--active {
  background-color: transparent;
  color: #F64C07;
  border: 1px solid #F64C07;
...
@-webkit-keyframes shadow-drop-center {
  0% {
    -webkit-box-shadow: 0 0 0 0 rgba(235, 133, 92, 0.7);
            box-shadow: 0 0 0 0 rgba(235, 133, 92, 0.7);
  }
  100% {
    -webkit-box-shadow: 0 0 15px 0px rgba(235, 133, 92, 0.7);
            box-shadow: 0 0 15px 0px rgba(235, 133, 92, 0.7);
  }
}
...
.connectWalletToDex_step6_balance-container {
  grid-column-gap: 24px;
  background-color: #1f1f1f0d;
  border: 1px solid #ebebeb;
  border-radius: 8px;
...
.connectWalletToDex_step6_check {
  color: #0000;
...
.connectWalletToDex_step6_check.is--checked {
  color: #f64c07;
  border-color: #f64c07;
}

.connectWalletToDex_step6_check-inner {
...
.connectWalletToDex_step6_copy-ico {
  opacity: .8;
  flex: none;
  width: 16px;
  height: 16px;
...
.connectWalletToDex_step6_add-ico, .btc-ico {
  ...
  height: 20px;
    ...
    rootEl.innerHTML = `
        <div class="connectWalletToDex_step6_canvas-wrap">
          <div data-sim-view-1 class="connectWalletToDex_step6_container">
            <div class="connectWalletToDex_step6_container-2">
              <div class="connectWalletToDex_step6_fauxui"></div>
              <div class="connectWalletToDex_step6_fauxui-2"></div>
              <div data-sim-trigger-1 class="connectWalletToDex_step6_buttons">
                <div class="connectWalletToDex_step6_wallet-info">
                  <div class="connectWalletToDex_step6_wallet-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 20 20" fill="none" class="connectWalletToDex_step6_wallet-ico">
              ...
              <div class="connectWalletToDex_step6_dropdown_wrap">
                <div class="connectWalletToDex_step6_container-6">
                  <div data-sim-view-2 class="connectWalletToDex_step6_container-7">
                    <div class="connectWalletToDex_step6_header-style">
                      <div class="connectWalletToDex_step6_title-style">Your wallets</div>
                      <div class="connectWalletToDex_step6_buttons-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 20 20" fill="none" class="connectWalletToDex_step6_add-ico">
                        ...
                        <div class="connectWalletToDex_step6_add-button">Add wallet</div>
                      </div>
                    </div>
                    <div class="connectWalletToDex_step6_wallet-list">
                      <div class="connectWalletToDex_step6_wallet-info-header">
                        <div class="connectWalletToDex_step6_wallet-label is--1">Wallet</div>
                        <div class="connectWalletToDex_step6_wallet-label is--alt">Network</div>
                        <div class="connectWalletToDex_step6_wallet-label is--alt-2">Balance</div>
                      </div>
                      <div data-sim-check-1 class="connectWalletToDex_step6_checkbtn">
                        <div class="connectWalletToDex_step6_wallet-info">
                          <div class="connectWalletToDex_step6_check is--checked">
                            <div class="connectWalletToDex_step6_check-inner"></div>
                          </div>
                          <div class="connectWalletToDex_step6_wallet-details">
                      ...
                      <div data-sim-check-2 class="connectWalletToDex_step6_checkbtn">
                        <div class="connectWalletToDex_step6_wallet-info">
                          <div class="connectWalletToDex_step6_check">
                            <div class="connectWalletToDex_step6_check-inner"></div>
                          </div>
                          <div class="connectWalletToDex_step6_wallet-details">
            ...
            <div class="connectWalletToDex_step6_container-3">
              <div class="connectWalletToDex_step6_container-4">
                <div class="connectWalletToDex_step6_fauxui-3"></div>
                <div class="connectWalletToDex_step6_container-5">
                  <div class="connectWalletToDex_step6_fauxui-4"></div>
                  <div class="connectWalletToDex_step6_fauxui-5"></div>
                </div>
              </div>
              <div class="connectWalletToDex_step6_fauxui-6"></div>
            </div>
          </div>
        </div>
    `;
    ...
    if (!view1 || !view2 || !trigger1 || !trigger2 || !check1) {
      console.warn("[connectWalletToDex_step6] Missing required elements.");
      done?.();
      return;
    }
    ...
    const handleTrigger2Click = () => {
      ...
      if (!gs) {
        check1.style.transition =
          "opacity 0.35s cubic-bezier(0.65, 0.05, 0, 1), background-color 0.35s cubic-bezier(0.65, 0.05, 0, 1)";
        check1.style.opacity = "0.4";
        check1.style.backgroundColor = "#e5e5e5";
        check1.style.pointerEvents = "none";

        setTimeout(() => safeDone(), 550);
        return;
      }
